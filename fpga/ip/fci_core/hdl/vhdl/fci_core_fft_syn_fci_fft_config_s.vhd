...
entity fci_core_fft_syn_fci_fft_config_s is
    generic (
...
architecture arch of fci_core_fft_syn_fci_fft_config_s is
    --------------------- Component ---------------------
    component fci_core_fft_syn_fci_fft_config_s_core_ip is
        port (
            aclk                        : in  std_logic;
            aclken                      : in  std_logic;
...
begin
    --------------------- Instantiation -----------------
    inst : component fci_core_fft_syn_fci_fft_config_s_core_ip
    port map (
        aclk                        => ap_clk,
        aclken                      => ap_ce,
        aresetn                     => aresetn,
