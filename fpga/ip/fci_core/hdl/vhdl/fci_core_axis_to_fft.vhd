...
entity fci_core_axis_to_fft is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
attribute shreg_extract : string;
    ...
    signal s_axis_data_TKEEP_int_regslice : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal s_axis_data_TSTRB_int_regslice : STD_LOGIC_VECTOR (1 downto 0);
    ...
    component fci_core_axis_to_fft_Pipeline_SAMPLE_LOOP IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    regslice_both_s_axis_data_V_keep_V_U : component fci_core_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_data_V_strb_V_U : component fci_core_regslice_both
    generic map (
        DataWidth => 2)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_data_V_last_V_U : component fci_core_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_data_V_id_V_U : component fci_core_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_s_axis_data_V_dest_V_U : component fci_core_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
