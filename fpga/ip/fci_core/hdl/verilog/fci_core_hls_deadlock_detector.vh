...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    fci_core_hls_deadlock_detect_unit #(4, 0, 2, 2) fci_core_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~entry_proc_U0.psa_l_lo_c_blk_n) | (~entry_proc_U0.psa_l_hi_c_blk_n) | (~entry_proc_U0.psa_w_lo_c_blk_n) | (~entry_proc_U0.psa_w_hi_c_blk_n);
    assign proc_0_data_PIPO_blk[0] = 1'b0;
    assign proc_0_start_FIFO_blk[0] = 1'b0 | (~start_for_fft_to_psa_U0_U.if_full_n & entry_proc_U0.ap_start & ~entry_proc_U0.real_start & (trans_in_cnt_1 == trans_out_cnt_1) & ~start_for_fft_to_psa_U0_U.if_read);
    ...
    assign proc_0_input_sync_blk[1] = 1'b0 | (ap_sync_entry_proc_U0_ap_ready & entry_proc_U0.ap_idle & ~ap_sync_axis_to_fft_U0_ap_ready);
    ...
    assign proc_2_start_FIFO_blk[0] = 1'b0 | (~start_for_fft_fci_fft_config_U0_U.if_empty_n & fft_fci_fft_config_U0.ap_idle & ~start_for_fft_fci_fft_config_U0_U.if_write);
    ...
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~fft_to_psa_U0.psa_l_lo_blk_n) | (~fft_to_psa_U0.psa_l_hi_blk_n) | (~fft_to_psa_U0.psa_w_lo_blk_n) | (~fft_to_psa_U0.psa_w_hi_blk_n);
    assign proc_3_data_PIPO_blk[1] = 1'b0;
    assign proc_3_start_FIFO_blk[1] = 1'b0 | (~start_for_fft_to_psa_U0_U.if_empty_n & fft_to_psa_U0.ap_idle & ~start_for_fft_to_psa_U0_U.if_write);
